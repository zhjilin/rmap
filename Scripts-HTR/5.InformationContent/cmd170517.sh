#Information content must be calculated from tree parts, due to the SLM model generates frequency table, instead the normal pwm is the count table. 
...
#the following section is for the STEM and LOOP comparision, also overall landscape
